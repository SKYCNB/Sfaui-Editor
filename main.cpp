...
int main(int, char**)
{
    ...
    // 使用缩放后字号，修复字体错位
    io.Fonts->AddFontFromFileTTF("C:\\Windows\\Fonts\\msyh.ttc", font_size, nullptr, io.Fonts->GetGlyphRangesChineseFull());
